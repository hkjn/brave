...
# TODO(hkjn): Enable tests (npm test), if test dependencies
# can be made to work. Attempting to add test packages with "npm install -g mocha babel-register" fails with:
